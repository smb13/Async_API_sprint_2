...
ES_EXISTED_MOVIES = ES_MOVIES_TEST_DATA[ES_MOVIES_A_HALF_OF_TEST_RECORDS - 1]
del ES_EXISTED_MOVIES['actors_names']
del ES_EXISTED_MOVIES['writers_names']
ES_EXISTED_MOVIES_UUID = ES_MOVIES_TEST_DATA[ES_MOVIES_A_HALF_OF_TEST_RECORDS - 1].get('uuid')
